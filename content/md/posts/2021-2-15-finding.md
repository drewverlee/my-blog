...
Auri later calls her sitting from Annulet, which means:
...
Annulets, and similar moldings can often be found in [architecture](https://en.wikipedia.org/wiki/Romanesque_architecture) of churches and *cathedrals*.
